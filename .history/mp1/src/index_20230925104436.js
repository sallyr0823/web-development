...
window.addEventListener("scroll", () => {
    ...
    bar.style.height = (20 - 2* (pageYOffset/height)) + 'vh';
    var container = document.getElementById('navcontainer');
    container.style.fontSize = (30 -  2*pageYOffset/height) + 'px';
  ...
  sections.forEach((section) => {
    ...
    else if (pageYOffset >= document.body.scrollHeight - window.innerHeight) {
      current = "video";
    }
