...
def main(argv):
    ...
    for i in range(taskCount):
        ...
        params = urllib.parse.urlencode({'name': choice(taskNames), 'deadline': deadline, 'assignedUserName': assignedUserName, 'assignedUser': assignedUser, 'completed': str(completed).lower(), 'description': description})
        print(params)
        # POST the task
